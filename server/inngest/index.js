...
export const inngest = new Inngest({ id: "social-media-website-pingup" });
...
const sendNewConnectionRequestRemainer = inngest.createFunction(
...
export const functions = [
  ...
  syncUserUpdation,
  syncUserDeletion,
  sendNewConnectionRequestRemainer,
  deleteStory,
